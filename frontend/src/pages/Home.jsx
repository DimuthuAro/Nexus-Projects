  ...
  return (
    <div className="min-h-screen flex flex-col text-white ">
      ...
      <section className="py-16 -mt-8">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid bg-black/60 grid-cols-2 md:grid-cols-4 mx-auto lg:mx-0 backdrop-blur-lg hover:bg-black/80 p-8 rounded-2xl shadow-[0_10px_30px_rgba(42,_92,_123,_0.3)] border border-[#5293b6]/20 transform hover:shadow-[0_10px_40px_rgba(42,_92,_123,_0.4)] transition-all duration-300">
